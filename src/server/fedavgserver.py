...
class FedavgServer(BaseServer):
    def __init__(self, **kwargs):
        ...
        # # NOTE: Creates model, optimizer, and clients.
        # self.args = args
        # self.writer = writer
        ...
        # server aggregator
        # are algorithms ever different from server?
        # TODO: algorithms are strongly tied to the server class. Is there a need for separate treatment?
